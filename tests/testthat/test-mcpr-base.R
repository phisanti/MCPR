...
test_that("resource cleanup registration works", {
  ...
  base$register_cleanup(
    function() { test_resource$active <<- FALSE },
    "test_resource"
  )
...
test_that("resource cleanup is executed in LIFO order", {
  ...
  base$register_cleanup(
    function() { execution_order <<- c(execution_order, "first") },
    "first"
  )
  
  base$register_cleanup(
    function() { execution_order <<- c(execution_order, "second") },
    "second"
  )
  
  base$register_cleanup(
    function() { execution_order <<- c(execution_order, "third") },
    "third"
  )
